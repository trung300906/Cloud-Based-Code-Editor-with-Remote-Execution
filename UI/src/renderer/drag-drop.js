  ...
  state.panes.forEach((pane) => {
    ...
    ov.querySelectorAll(".pdz").forEach((z) => {
      ...
      z.addEventListener("drop", (e) => {
        ...
        switch (act) {
          case "center":
            handleDropMove(tabId, pane.id);
            break;
          case "left":
            handleDropSplit(tabId, pane.id, "horizontal", "before");
            break;
          case "right":
            handleDropSplit(tabId, pane.id, "horizontal", "after");
            break;
          case "top":
            handleDropSplit(tabId, pane.id, "vertical", "before");
            break;
          case "bottom":
            handleDropSplit(tabId, pane.id, "vertical", "after");
            break;
        }
      });
    });
